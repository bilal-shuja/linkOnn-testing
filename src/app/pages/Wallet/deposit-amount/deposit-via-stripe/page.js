                    ...
                    <div className="row">
                        ...
                        <div className="col-md-9 p-3 mt-4">
                            ...
                            <div className="card shadow-lg p-3 border-0">
                                <div className="card-body">
                                    <h5 className="card-title d-flex justify-content-center text-dark fw-bold mb-4 mt-3">Deposit via Stripe</h5>
                                    <div className="d-flex justify-content-center">
                                        <form className="w-50">
                                            <div className="mb-3">
                                                <label htmlFor="cardNumber" className="form-label text-muted">
                                                    Card Information
                                                </label>
                                                <div className="input-group">
                                                    ...
                                                    <button type="button" className="btn btn-dark">
                                                        <span className="fw-bold text-light">Autofill</span>
                                                        <span className="fw-bold text-success mx-1">link</span>
                                                    </button>
                                                </div>
                                            </div>
