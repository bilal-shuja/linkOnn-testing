...
export default function EnableDisableCommentsModal({ postID ,posts ,setPosts ,showEnableDisableCommentsModal, setShowEnableDisableCommentsModal }) {
    ...
    return (
        <>
            <Modal
                show={showEnableDisableCommentsModal}
                centered
            >
                ...
                <Modal.Footer>
                    <button className='btn btn-sm btn-primary ps-4 pe-4' onClick={enableDisableComment}>
                        Yes !
                    </button>
                    <button className='btn btn-sm btn-danger  ps-4 pe-4' onClick={handleClose}>
                        No
                    </button>
