        ...
        if (window.confirm("Are you sure you want to delete this post?")) {
            try {
                ...
                if (response.data.code == 200) {
                    ...
                    setMessage("Post successfully deleted"); // Success message
                } else {
                    setMessage("Failed to delete the post."); // Error message
                }
            } catch (error) {
                setMessage("An error occurred while deleting the post."); // Error message
            }
        }
    };
